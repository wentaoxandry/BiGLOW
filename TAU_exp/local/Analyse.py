...
def plot(allacc, allacc1, modal, modal1, imagedir):
    fontsize = 15
    ticks = ['24', '32', '64', '128', '256']  # , '1024', '2048']
    data = []
    labels = []
    x = [0, 1, 2, 3, 4]  # , 8, 9]
    for nsplit in ticks:
    ...
    data1 = []
    for nsplit in ['24', '32', '64', '128', '256']:  # , '1024', '2048']:
...
def get_args():
    ...
    parser.add_argument('--imagedir', default='./../Images', type=str, help='Dir saves the print Figures')
    parser.add_argument('--savedir', default='./../trained', type=str, help='Dir saves the trained model and results')
...
if __name__ == '__main__':
    ...
    for modal in ['Global_linear', 'Global_logarithmic', 'Global_logit']:
    ...
    multi_plot([deltaacc, pairwiseacc, pairwiseforceacc], ['delta fusion', 'pairwise fusion', 'forced pairwise fusion'], imagedir)

    for modal in ['Global_logarithmic']:
