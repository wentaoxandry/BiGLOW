...
if __name__ == '__main__':
    ...
    cvfolder = os.path.join(datasdir, 'subsets_trainingset')
    ...
    for M in [24, 32, 64, 128, 256]:
        ...
        for id in range(10):
            ...
            with open(os.path.join(datasdir, "subsets_trainingset", str(M), str(id) + ".json"), encoding="utf8") as json_file:
            ...
            for i in range(N):
                prior.update({i: []})
            for workdict, dset in zip([traindict, testdict], ["train", "test"]):
